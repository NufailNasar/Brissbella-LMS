                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Empower Your Learning</h5>
            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Flexible Learning</h5>
                                <h1 class="display-3 text-white animated slideInDown">Learn Anytime, Anywhere with Brissbella LMS</h1>
                                <p class="fs-5 text-white mb-4 pb-2">Manage courses, track assignments, process fees, and communicate seamlessly across all user roles.</p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Explore Features</a>
                                <a href="signin.php" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Login Now</a>
                            </div>
                        </div>
                    </div>
                </div>
